...
function ModalApp(props) {
    ...
    function register({ auth_token, topic, token , address, action}) {
        ...
        var requestOptions = {
            ...
            body: JSON.stringify({ auth_token, topic, token , input, address:action}),
        };
    ...
    return (
        <div>
            <button onClick={openModal} className="ui button">Register Icon/Eth Notification</button>
            <Modal
                isOpen={modalIsOpen}
            ...
            >
                ...
                <div>
                    ...
                    <div className="ui input focus">
                        <input type="text" placeholder="Address in BTP format" value={address} onChange={(event) => SetAddress(event.target.value)}/>
                    </div>
                </div>
                <div>
                    <div className="label">
                ...
                <div className="ui grid">
                    <div className="four column centered row">
                        <button onClick={() => register({ auth_token: user_auth, topic: selected, token })} className={"ui primary button ".concat(busy ? "disabled loading" : "")}>register</button>
