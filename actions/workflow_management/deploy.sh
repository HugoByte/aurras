...
--auth "$openwhiskApiKey" --param event_registration_db "event_registration_db" --param workflow_management_db "workflow_management_db" --param db_name "payout_registration_db" --param db_url "http://admin:p@ssw0rd@172.17.0.1:5984" --web true
